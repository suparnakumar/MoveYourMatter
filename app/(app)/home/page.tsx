...
export default async function HomePage() {
  ...
  const { data: membership } = await supabase
    .from("cohort_members")
    .select("cohort_id, cohorts(name, start_date, whatsapp_link, zoom_url)")
    .eq("user_id", user!.id)
    .maybeSingle();
            ...
            {cohort.zoom_url && (
              ...
              >
                <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M4 6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6zm14.5 3.5-4 2.5v-5l4 2.5z"/>
                </svg>
                Join Zoom
              </a>
            )}
